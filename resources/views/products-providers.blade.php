                ...
                <form class="p-4 md:p-5" action="{{route('products-providers.store')}}" method="POST">
                    ...
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        ...
                        <div class="col-span-2">
                            ...
                            <input type="number" step="0.1" name="product_price" id="price" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 " placeholder="Añadir un precio" required="">
                        </div>
                        <div class="col-span-2">
            ...
            <x-modal name="products" id="modal-edit">
                ...
                <form class="form-edit p-4 md:p-5" action="{{route('products-providers.update')}}" method="POST">
                    ...
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        ...
                        <div class="col-span-2">
                            <label for="price" class="block mb-2 text-sm font-medium text-gray-900 ">Price</label>
                            <input type="number" step="0.1" name="product_price" id="price" class="edit-input bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 " placeholder="Añadir un precio" required="">
                        </div>
                        <div class="col-span-2">
                            <label for="stock" class="block mb-2 text-sm font-medium text-gray-900 ">Stock</label>
